...
- **Spanner client errors**  
  Ensure `SPANNER_EMULATOR_HOST=localhost:9010` and the emulator is running (`docker-compose up -d`). Instance and database must exist and DDL applied.
